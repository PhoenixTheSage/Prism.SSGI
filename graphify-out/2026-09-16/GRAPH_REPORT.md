...
## Corpus Check
- 31 files · ~9,341 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 382 nodes · 651 edges · 15 communities
...
Cohesion: 0.11
Nodes (21): DenoiserCb, SSGIPass, AfterFrames, BeforeFrames, DenoiserCompileError, DenoiserError, LastSkip, LastTraceSrv (+13 more)
...
Cohesion: 0.12
Nodes (9): AnomalyHook, PackRegistered, RegistryFound, Action, IntPtr, ISrvBindable, MethodInfo, MyRenderContext (+1 more)

### Community 5 - "StatusScreen"
Cohesion: 0.38
Nodes (4): StatusScreen, IEnumerable, StringBuilder, MyGuiScreenBase

### Community 6 - "GuiScreenSSGIConfig"
Cohesion: 0.06
Nodes (38): HorizontalAlignment, Center, Left, Right, Item, Column, HorizontalAlignment, Row (+30 more)
...
Cohesion: 0.07
Nodes (23): Attribute, ConfigPropertyAttribute, Enabled, Name, ToolTip, FloatConfigPropertyAttribute, DefaultValue, Max (+15 more)

### Community 10 - "BufferMapping"
Cohesion: 0.14
Nodes (11): Buffer, BufferMapping, IntPtr, Extensions, MyRenderContext, Random, DeviceContext, IBuffer (+3 more)
...
- **Why does `ClientPlugin.Config` connect `ClientPlugin.Config` to `SSGIConfig`, `GuiScreenSSGIConfig`?**
  _High betweenness centrality (0.147) - this node is a cross-community bridge._
- **Why does `GuiScreenSSGIConfig` connect `GuiScreenSSGIConfig` to `Plugin`, `SSGIConfig`, `StatusScreen`?**
