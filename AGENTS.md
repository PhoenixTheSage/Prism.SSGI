...
When this pack invents lighting, IsolatedMix energy, or march LOD that the next Anomaly shader will also need, file it on Anomaly (`Docs/Extensibility.md` Slice AI, `wiki/Framework-gaps.md`) — see `.cursor/rules/anomaly-own-the-gap.mdc`.
